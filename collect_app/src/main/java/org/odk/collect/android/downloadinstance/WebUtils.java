...
public final class WebUtils {
	...
	private static final void setOpenRosaHeaders(HttpRequest req) {
		...
		req.setHeader(DATE_HEADER,
				org.opendatakit.httpclientandroidlib.client.utils.DateUtils.formatDate(new Date(), org.opendatakit.httpclientandroidlib.client.utils.DateUtils.PATTERN_RFC1036));
	}
