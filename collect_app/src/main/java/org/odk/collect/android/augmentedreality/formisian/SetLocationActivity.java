...
public class SetLocationActivity extends AppCompatActivity implements View.OnClickListener,OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llMarker = (LinearLayout)findViewById(R.id.locationMarker) ;
...
//                if(Permission.cekStoragePermission(this)){
                    DialogInputTempat dialogInputTempat = new DialogInputTempat(this, mCenterLatLong .latitude, mCenterLatLong.longitude);
